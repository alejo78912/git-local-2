...
<section id="blog">
        <div class="contenedor">
          ...
          <select class="formulario__select">
            ...
            <label for="Cod_ca" class="fomulario__label">Ingrese el codigo de la casa:</label><input type="numbers" placeholder="Digite su numero de identificación" maxlength="11" name="Cod_ca" id="Cod_ca"  class="formulario__input">
            
            <label for="di_ca" class="fomulario__label">Ingrese la dirección de la casa:</label> <input type="name" placeholder="Digite su nombre" maxlength="20" name="di_ca" id="di_ca" class="formulario__input">
      ...
      <div class="borrado">
         <center><a href="Formulario-ventas.php"><p>para el codigo de la venta, aquí.</p></center></a> 
         <center><a href="Formulario-borrado-casas2.php"><p>eliminar datos, entre aquí.</p></center></a>
         <center><a href="Formulario-actualización-casas2.php"><p>actualizar datos, entre aquí.</p></center></a>  
...
$consulta="INSERT INTO casas(Cod_ca, di_ca, cod_ma1, cod_m1) values ('$Cod_ca', '$di_ca', '$cod_ma1', '$cod_m1')";
