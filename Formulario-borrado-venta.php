...
<section id="blog">
        <div class="contenedor">
           ...
           <h1 class="formulario__titulo">Eliminación de datos</h1>
            ...
            <label for="Ven_ca" class="fomulario__label">Ingrese el codigo de la venta:</label><input type="numbers" placeholder="Ingrese el codigo de la venta" maxlength="11" name="Ven_ca" id="Ven_ca"  class="formulario__input" >
            
            <label for="Va_v" class="fomulario__label">Ingrese el valor de la casa:</label> <input type="name" placeholder="Digite el valor de la casa" maxlength="20" name="Va_v" id="Va_v" class="formulario__input" >
            <br><br>
          <select class="formulario__select">
            ...
            <label for="cc_C1" class="fomulario__label">Ingrese su numero de identificación:</label> <input type="number" placeholder="Digite su numero de identificación" maxlength="29" name="cc_C1" id="cc_C1" class="formulario__input" >
...
<?php
      ...
      $consulta="delete from clientes where ven_ca = '$Ven_ca'";
