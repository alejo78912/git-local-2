...
<?php
      ...
      echo "<label class='fomulario__label'> numero de identificación:<input type = 'numbers' class='formulario__input' name = 'cc_e' value = '" . $fila['cc_e'] . "' readonly></label><br>";
      echo "<label class='fomulario__label'>Nombre:<input type = 'name' class='formulario__input' name = 'nom_e' value = '" . $fila['nom_e'] . "'></label><br>";
      echo "<label class='fomulario__label'>Apellido:<input type = 'surname' class='formulario__input' name = 'Ape_e' value = '" . $fila['Ape_e'] . "'></label><br>";
      echo "<label class='fomulario__label'>Codigo de servicio:<input type = 'service cod' class='formulario__input' name = 'cod_s1' value = '" . $fila['cod_s1'] . "'></label><br>";
...
<?php         
      ...
      $consulta="UPDATE clientes SET cc_e = '$cc_e', nom_e = '$nom_e', Ape_c = '$Ape_e', cod_s1 = '$cod_s1'  WHERE cc_e = '$cc_e'";
