...
<section id="blog">
        <div class="contenedor">
          ...
          <select class="formulario__select">
            ...
            <label for="cod_s1" class="fomulario__label">Ingrese su codigo de serivicio:</label> <input type="service cod" placeholder="Digite su codigo de serivicio" maxlength="10" name="Tel_C" id="cod_s1" class="formulario__input" > 
...
<?php
      ...
      $consulta="delete from empleados where cc_e = '$cc_e'";
