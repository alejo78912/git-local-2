...
<section id="blog">
        <div class="contenedor">
          ...
          <select class="formulario__select">
            ...
            <label class="fomulario__label">Ingrese el codigo de la venta:<input type="numbers" placeholder="Digite su numero de identificación" maxlength="11" name="buscar" class="formulario__input"></label>
...
<?php
      ...
      $consulta="SELECT Ven_ca, Va_v  FROM ventas where Ven_ca like '%$busqueda%'";
      ...
      echo "<label class='fomulario__label'> numero de identificación:<input type = 'numbers' class='formulario__input' name = 'Ven_ca' value = '" . $fila['Ven_ca'] . "' readonly></label><br>";
      echo "<label class='fomulario__label'>Nombre:<input type = 'name' class='formulario__input' name = 'Va_v' value = '" . $fila['Va_v'] . "'></label><br>";
...
<?php         
      ...
      $consulta="UPDATE ventas SET Ven_ca = '$ven_ca', Va_v = '$va_v'  WHERE Ven_ca = '$Ven_ca'";
