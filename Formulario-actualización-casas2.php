...
<section id="blog">
        <div class="contenedor">
          ...
          <select class="formulario__select">
            ...
            <label class="fomulario__label">Ingrese el codigo de la casa:<input type="numbers" placeholder="Digite su numero de identificación" maxlength="11" name="buscar" class="formulario__input"></label>
...
<?php
      ...
      $consulta="SELECT Cod_ca, di_ca   FROM casas where Cod_ca like '%$busqueda%'";
      ...
      echo "<label class='fomulario__label'> numero de identificación:<input type = 'numbers' class='formulario__input' name = 'Cod_ca' value = '" . $fila['Cod_ca'] . "' readonly></label><br>";
      echo "<label class='fomulario__label'>Nombre:<input type = 'name' class='formulario__input' name = 'di_ca' value = '" . $fila['di_ca'] . "'></label><br>";
...
<?php         
      ...
      $consulta="UPDATE casas SET Cod_ca = '$Cod_ca', di_ca = '$di_ca'  WHERE cc_C = '$Cod_ca'";
